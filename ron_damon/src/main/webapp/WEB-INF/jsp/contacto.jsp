...
<div class="container w-75">
	<p class="text-center text-primary my-5 display-4 font-italic">pagina contacto<p>
</div>
<footer>
  <div class="container-fluid bg-secondary py-3 my-3">
  <p class="text-white text-center">CopyRight Derechos Reservados, Chile 2020 - <a style="font-size:140%;color:blue" href="contacto" id="fono">contacto</a></p>
  </div>
</footer>
</body>
</html>
